...
framesdir = '/Users/sanjana/gatech/cv/assignments/ps4/frames/'
siftdir = '/Users/sanjana/gatech/cv/assignments/ps4/sift/'
...
ax.imshow(im)
coners = computeSIFTPatches(mat['positions'], mat['scales'], mat['orients'])
...
bx.imshow(im)
coners = computeSIFTPatches(mat['positions'][randinds[:N], :], mat['scales'][randinds[:N], :], mat['orients'][randinds[:N], :])
...
bx=fig.add_subplot(111)
bx.imshow(im)
coners = computeSIFTPatches(mat['positions'][Ind, :], mat['scales'][Ind, :], mat['orients'][Ind, :])
